...
<body>
<center>
<form name ='ingredient_insert' method='POST' action='ingredient_input.php'>
<table width='100%' height='100%' cellpadding='0' cellspacing='0'>
	<tr>
		<td height='250' align='center' valign='middle'>
<font face='HY나무M' size='4'>등록&nbsp;&nbsp;|&nbsp;&nbsp;<a href='ingredient_update.php'>수정</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='ingredient_delete.php'>삭제</a></font><br><br>
<font face='HY나무M' size='5'><b>원재료 등록</b></font>
<table cellpadding='0' cellspacing='0' width='300px' border='1' bordercolordark='white' bordercolorlight='#75bbd4'>
	...
	<tr>
		<td width='300' height='2' align='center' colspan='2'>
			<font size='4' face='HY나무M'><input type='submit' value='   입 력   '></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size='4' face='HY나무M'><input type='reset' value='   취 소   '></font>
		</td>
	</tr>
</table>
		</td>
